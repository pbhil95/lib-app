...
SECRET_KEY = 'u5(p_yt1x@k401!ten4u+_zkv3&44m0(n*c**6#j2j%4$@t%ep'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'libapp/template')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
AUTH_USER_MODEL = 'libapp.MyUser'
#AUTH_PROFILE_MODULE = 'myauth.Profile'
